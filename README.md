...
11. `게임 템플릿`에는 게임마다 다른 자유 형식 템플릿을 카드로 저장하고, 현재 사용할 템플릿을 선택합니다.
12. `등장인물`에는 선택한 게임의 인물 이름과 짧은 설명을 추가합니다.
13. 필요하면 뜻과 내 문장을 가볍게 덧붙입니다.
14. 저장된 카드에서 `원문 듣기`와 `내 문장 듣기`를 눌러 소리 내서 연습합니다.
15. 익숙해진 문장은 `연습 완료`로 체크합니다.
...
- record data: 개인 게임 목록과 게임별 미션 체크, 단어장, 스토리 메모, 문장 노트, 게임 템플릿, 등장인물
      ...
      t: [
        {
          i: "template-1",
          t: "감정 표현",
          b: "I felt like the whole house was holding its breath.",
          g: "emotion, story"
        }
      ],
      q: "template-1",
...
게임 템플릿은 `t`, 선택된 템플릿 id는 `q`, 등장인물은 `p`에 저장되며, 값이 없으면 저장하지 않습니다.
